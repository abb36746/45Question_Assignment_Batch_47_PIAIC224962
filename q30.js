...
let userName = ["admin", "Ali Abbas", "Muhammad Ahmad", "Ali Shan", "Muhammad Aslam"];
function userGreet() {
    for (const key in userName) {
        if (userName[key].toLowerCase() === "admin") {
            console.log(`Hello admin, would you like  to see a status report?`);
        }
        else {
            console.log(`Hello ${userName[key]}, thank you for logging in again.`);
        }
    }
}
userGreet();
